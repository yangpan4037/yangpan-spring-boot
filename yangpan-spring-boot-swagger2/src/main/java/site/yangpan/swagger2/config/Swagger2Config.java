package site.yangpan.swagger2.config;
...
/**
 * Swagger2Config
 * Created by yangpan on 2019-07-14 20:28.
 */
@Configuration
@EnableSwagger2
...
public class Swagger2Config {
    ...
    public Docket swaggerApi() {
        ...
        token.name("Authorization").description("请求头携带的token").modelRef(new ModelRef("string")).parameterType("header").required(true).build();
