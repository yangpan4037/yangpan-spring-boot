...
@Component
@Order(value=1)
public class StartupRunner1st implements CommandLineRunner {

    @Override
    public void run(String... args) throws Exception {
        System.out.println("StartupRunner1st，实现CommandLineRunner接口，服务启动执行。。");
        String strArgs = Arrays.stream(args).collect(Collectors.joining(" | "));
        System.out.println("StartupRunner1st，接收到参数" + strArgs);
        System.out.println("\n");
    }
